<?php
$title = "Happy Horologists Pitch Deck";
$description = "This page describes everything about Happy Horologists and what we are all about";
$pageclass = "page-home";
...
<div class="container">
    <section class="systems">
        ...
        <!-- Header -->
        <div class="columns is-variable is-12 mb-12 heading">            
        ...
        <div class="columns is-variable is-4 mb-4">
            <div class="column is-one-quarter-desktop is-half-tablet">
                <?php echo simpleCard("Sony Alpha 7 II", "mirrorless professional camera - 24MP resolution", "growthBack possibilityFront"); ?>                                                        
            </div>
